...
class ProductController extends Controller
{
    ...
    public function add(ProductAddRequest $request)
    {
        ...
        return response()->json([
            'msg' => 'Thêm thành công '.$request->product_name,
        ], 200);
    }
    ...
    public function getProductInfoEdit($id){
        $data = Product::where('product_id', $id)->first();
        return response()->json([
            'data' => $data,
        ], 200);
    ...
    {
        $update = Product::where('product_id', $request->product_id)->first();
        ...
        $update->save();
        return response()->json([
            'msg' => 'Cập nhật thành công '.$request->product_name,
        ], 200);
    }
